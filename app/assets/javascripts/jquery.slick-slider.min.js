/* ============================ TOC ==============================
1. Slick
2. .variable-width-slider
3. .multi-item-slick NOT .multi-item-slick-mini
4. .multi-item-slick-mini NOT .multi-item-slick
5. .single-item-carousel
6. .eq-slider
7. .blog-slider
8. .video-slider
9. .portfolio-item-slider
10. .testimonial-slider
11. removeClass .loading-slick on ALL sliders except variable-width-slider (since it's already there)
================================================================ */
/* --------------- 1. Slick --------------- */
/*
     _ _      _       _
...
|___/_|_|\___|_|\_(_)/ |___/
 ...
 ------- BUG FIX: https://github.com/kenwheeler/slick/issues/1088
 I had to get the unpacked version, plug in the fix and then re-minify
...
! function(i) {
    ...
    e = function() {
        ...
        var o, s, n, l = this,
            r = i(e.target);
        switch (r.is("a") && e.preventDefault(), n = l.slideCount % l.options.slidesToScroll !== 0, o = n ? 0 : (l.slideCount - l.currentSlide) % l.options.slidesToScroll, e.data.message) {
            case "previous":
        ...
        var i, e = this,
            ...
            o = 0,
            s = [];
        for (e.options.infinite === !1 ? (i = Math.ceil(e.slideCount / e.options.slidesToShow) * e.options.slidesToShow, e.options.centerMode === !0 && (i = e.slideCount)) : (t = -1 * e.options.slidesToScroll, o = -1 * e.options.slidesToScroll, i = 2 * e.slideCount); i > t;) s.push(t), t = o + e.options.slidesToScroll, o += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
        return s
...
$(function() {
    ...
    setTimeout(
        function() {
            ...
            $('.variable-width-slider').removeClass('loading-slick');


        }, 1500);

    /* --------------- 3. .multi-item-slick NOT .multi-item-slick-mini --------------- */
    $('.multi-item-slick').slick({
        dots: true,
        infinite: false,
    ...
    $('.multi-item-slick').on('setPosition', function(event, slick, currentSlide, nextSlide) {
        console.log(slick);
        var containerSize = $('body').width();
        if (containerSize <= 767) {
            $(".multi-item-slick .slick-dots").insertBefore($(".multi-item-slick .slick-list"));
        }
    });


    /* --------------- 4. .multi-item-slick-mini NOT .multi-item-slick --------------- */
    $('.multi-item-slick-mini').slick({
        dots: true,
        infinite: false,
        lazyLoad: 'progressive',
        adaptiveHeight: true,
    ...
    $('.multi-item-slick-mini').on('setPosition', function(event, slick, currentSlide, nextSlide) {
        console.log(slick);
        var containerSize = $('body').width();
        if (containerSize <= 767) {
            $(".multi-item-slick-mini .slick-dots").insertBefore($(".multi-item-slick-mini .slick-list"));
        }
    });
    ...
    $('.eq-slider').slick({
        ...
        autoplay: false,
        onInit: function() {
            $(".eq-slider .slick-dots").insertBefore($(".eq-slider .slick-list"));
        }
    });
    ...
    $(".video-case").fadeIn('slow');

    $('.video-slider .slick-slider-item a').on('click', function(event) {
        var $this = $(this);
    ...
    $(".testimonial-slider .slick-dots").insertBefore($(".testimonial-slider .slick-list"));


    /* --------------- 11. removeClass .loading-slick on ALL sliders except variable-width-slider (since it's already there) --------------- */
    var delay = setTimeout(function() {
        $('.single-item-carousel, .blog-slider, .eq-slider, .multi-item-slick-mini, .testimonial-slider, .multi-item-slick, .portfolio-item-slider, .portfolio-thumb-slider, .video-slider').removeClass('loading-slick');
    }, 800)
